...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LED_Green_Pin|LED_Red_Pin|Gate_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LED_Green_Pin LED_Red_Pin Gate_EN_Pin */
  GPIO_InitStruct.Pin = LED_Green_Pin|LED_Red_Pin|Gate_EN_Pin;
